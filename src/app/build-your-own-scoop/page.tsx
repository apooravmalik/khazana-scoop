...
const infoCards = [
  {
    body: "Select your favourite basic and premium products.",
    title: "You choose everything",
  },
  {
...
export default function BuildYourOwnScoopPage(): React.ReactElement {
  return (
    <main className="min-h-screen bg-[#fffaf5]">
      <StorefrontHeader currentPath="/build-your-own-scoop" />

      <div className="mx-auto w-[min(1160px,calc(100%-28px))] px-4 py-7">
        <section className="grid gap-6 rounded-[28px] border border-[#ded3ef] bg-[linear-gradient(135deg,#f2edff,#fcfaff)] px-6 py-8 shadow-[0_14px_36px_rgba(39,78,72,0.09)] lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-8">
          <div>
            ...
            <p className="mt-3 max-w-[620px] text-[15px] leading-[1.7] text-[#71827f]">
              Choose a box size, select every basic and premium product yourself, and create your perfect Khazana.
            </p>
          </div>

          <div className="relative min-h-[280px] overflow-hidden rounded-[22px] bg-white">
            <Image
              alt="Build Your Own Khazana Scoop"
        ...
        <section className="mt-6">
          <ScoopBuilderClient variant="build" />
        </section>
      </div>
