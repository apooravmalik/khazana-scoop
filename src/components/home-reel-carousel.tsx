...
import { HOME_REELS } from "@/lib/storefront-curation";
          ...
          >
            <div className="relative aspect-[9/16] overflow-hidden rounded-[22px] bg-[linear-gradient(180deg,#ffe7ef_0%,#f5efff_55%,#e5f8f6_100%)]">
              <video
                ...
                src={card.src}
              />
              <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(7,59,61,0.08)_0%,transparent_35%,rgba(7,59,61,0.46)_100%)]" />
              <div className="absolute inset-x-3 top-3 flex items-center justify-between">
                ...
                <span aria-label="Video is muted" className="grid h-9 w-9 place-items-center rounded-full bg-[#173f3b] text-white shadow-sm">
                  <VolumeX size={15} />
                </span>
              </div>
              <div className="absolute inset-x-4 bottom-4">
                <h3 className="text-[22px] font-black leading-[1.02] tracking-[-0.04em] text-white drop-shadow-[0_2px_5px_rgba(7,59,61,0.28)]">
                  {card.title}
                </h3>
              </div>
            </div>
